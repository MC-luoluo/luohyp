...
public class Duels {
    public static void duels(CommandSender context, String player, String type) throws IOException, URISyntaxException {
        MessageChainBuilder main = new MessageChainBuilder();
        ...
        if (json.get("player").isJsonObject()) {
            ...
            main.append(new PlainText(Rank.rank(playerJson)));
...
//                } else solo.append(new PlainText("null"));
        ...
        if (context.getSubject()!=null) {
            ...
            builder.add(Objects.requireNonNull(context.getBot()).getId(), context.getBot().getNick(), main.build());
            builder.add(context.getBot().getId(), context.getBot().getNick(), solo.build());
            builder.add(context.getBot().getId(), context.getBot().getNick(), team.build());
            builder.add(context.getBot().getId(), context.getBot().getNick(), other.build());
            context.sendMessage(builder.build());
        }else {
            context.sendMessage(main.build());
            context.sendMessage(solo.build());
            context.sendMessage(team.build());
            context.sendMessage(other.build());
        }
    }
